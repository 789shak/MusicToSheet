...
# ─── MusicXML generation ──────────────────────────────────────────────────────
# The actual implementation lives in musicxml_generation.py so the unit
# tests can import it without booting the full FastAPI / httpx / librosa
# stack. Re-exported here under the original name so the call sites in
# this file stay unchanged.
from musicxml_generation import generate_musicxml  # noqa: E402
